            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="shadow-xl flex flex-col items-center mb-12 p-6 rounded-sm">
                    <div className="w-full max-w-sm flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center mt-3">
                            <h1 className="text-[#3E54A3] font-bold text-lg md:text-xl">Kevin Powell</h1>
                            <span className="text-gray-600 text-sm md:text-base">Web Developer & YouTuber</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="shadow-xl flex flex-col items-center mb-12 p-6 rounded-sm">
                    <div className="w-full max-w-sm flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center mt-3">
                            <h1 className="text-[#3E54A3] font-bold text-lg md:text-xl">Jessica Chan</h1>
                            <span className="text-gray-600 text-sm md:text-base">Web Developer & YouTuber</span>
                        </div>
                    </div>
                </div>
